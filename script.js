...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-04-17T18:49:59.371Z',
    '2023-04-18T12:01:20.894Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
function displayMovements(acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const formattedMove = formatCurr(mov, acc.locale, acc.currency);
...
// Rule: Only grant loan if has one desposit with at least 10% of loan amount
